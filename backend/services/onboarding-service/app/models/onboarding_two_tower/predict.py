...
def predict_with_runtime(
    ...
    scores = tf.linalg.matmul(user_embedding, item_embeddings, transpose_b=True)[0].numpy()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--budget-level", type=int, default=None)
    parser.add_argument("--stability-level", type=int, default=None)
    parser.add_argument("--subway-dependency-level", type=int, default=None)
    parser.add_argument("--weekend-preference-level", type=int, default=None)
    parser.add_argument("--evening-preference-level", type=int, default=None)
    parser.add_argument("--resident-focus-level", type=int, default=None)
    parser.add_argument("--worker-focus-level", type=int, default=None)
    parser.add_argument("--rent-sensitivity-level", type=int, default=None)
    parser.add_argument("--competition-tolerance-level", type=int, default=None)
