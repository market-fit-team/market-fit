...
type ChatModelSelectionStore = {
  ...
  setSelectedModel: (modelId: string, reasoningEffort: ChatReasoningEffort) => void
  setSelectedReasoningEffort: (reasoningEffort: ChatReasoningEffort) => void
}

export const useChatModelSelectionStore = create<ChatModelSelectionStore>((set) => ({
  selectedModelId: null,
  selectedReasoningEffort: null,
  setSelectedModel: (modelId, reasoningEffort) => {
    set({ selectedModelId: modelId, selectedReasoningEffort: reasoningEffort })
  },
